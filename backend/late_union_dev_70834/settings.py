"""
Django settings for late_union_dev_70834 project.
...
ROOT_URLCONF = 'late_union_dev_70834.urls'
...
WSGI_APPLICATION = 'late_union_dev_70834.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_union_dev_70834 API",
    "DESCRIPTION": "API documentation for late_union_dev_70834 App",
    "VERSION": "v1",
}
